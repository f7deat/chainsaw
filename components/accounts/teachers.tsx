...
const Teachers: React.FC<TeachersProps> = (props) => {
    return (
        <div className="md:mb-32 mb-4">
            <div className="md:flex gap-10 md:mb-40 mb-10 items-center" data-aos="fade-up">
                <div className="md:w-1/2">
                    <div className="relative" style={{
                        ...
                        <div className="absolute shadow rounded-lg bg-white left-10 top-10 w-full">
                            ...
                            <div className="p-10">
                                <div className="md:flex justify-between mb-6 gap-10">
                                    ...
                                    <div className="relative px-4">
                                        ...
                                        <div className="absolute bottom-2 bg-gray-500 rounded-lg px-2 text-sm text-white left-6">
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="w-72">
                                        <div className="font-medium text-lg text-gray-600">Học trực tuyến</div>
                                        <div className="text-gray-400">Trực tiếp giảng dạy trực tuyến</div>
                                    </div>
                                    <button type="button" className="text-white px-6 py-2 rounded-full text-lg relative font-medium" style={{
            ...
            <div className="text-center py-4">
                <Link href="/tai-khoan/giao-vien" className="border rounded-full border-blue-500 text-blue-500 py-3 px-6 hover:bg-blue-500 hover:text-white text-xl">
                    Tìm hiểu thêm
                </Link>
            </div>
        </div>
