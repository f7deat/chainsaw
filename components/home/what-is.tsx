...
const WhatIs: React.FC = () => {
    ...
    const Item = (image: string, title: string, isPrimary: boolean) => (
        <div className="relative flex justify-center">
            ...
            <div className="absolute h-full w-full flex items-center justify-center flex-col">
                <div className="md:text-3xl text-xl font-medium text-white md:mb-6 mb-3 uppercase">{title}</div>
                {
                    !isPrimary && (<Link href="/admin/login" className="text-white transition duration-500 hover:bg-sky-400 md:text-xl font-medium md:px-10 px-4 md:py-3 py-2 rounded-full border border-white">Bắt đầu ngay</Link>)
                }
                {
                    isPrimary && (
                        <Link href="/tai-khoan/dang-ky" className="text-white transition duration-500 bg-sky-400 hover:bg-transparent md:text-xl font-medium md:px-10 px-4 md:py-3 py-2 rounded-full border border-white" style={{
                            opacity: 0.9
                        }}>Bắt đầu học</Link>
                    )
                }
    ...
    return (
        <div className="mb-4" data-aos='fade-up'>
            ...
            <div className="text-center mx-auto text-slate-500 md:text-lg md:mb-16 mb-8" style={{
                maxWidth: 1100
            }}>
